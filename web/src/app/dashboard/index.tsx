...
export default function DashboardLayout() {
  const { isXyzenOpen, panelWidth, layoutStyle } = useXyzen();
  ...
  // 检查是否是全屏模式 - 当 layoutStyle 不是 'sidebar' 时认为是全屏
  const isFullscreen = layoutStyle !== 'sidebar';
