...
export const TopicTag = ({ topic, count }: TopicTagProps) => {
  return (
    <Link
      to={`/topics/${topic}`}
      className="flex items-center justify-between rounded-lg border border-neutral-100 p-2 transition-all hover:border-blue-200 hover:bg-blue-50 dark:border-neutral-800 dark:hover:border-blue-700 dark:hover:bg-blue-900/20"
    >
