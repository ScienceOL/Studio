...
export default function FeatureOfBlog() {
  return (
    <div className="bg-white py-24 dark:bg-neutral-950 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-neutral-600 dark:text-neutral-300">
            Share your thoughts and ideas with the world. Connect with other
            like-minded individuals and grow your audience.
          </p>
        </div>
            ...
            >
              <div className="relative w-full">
                <img
                  src={post.imageUrl}
                  alt=""
                  className="aspect-[16/9] w-full rounded-2xl bg-neutral-100 object-cover dark:bg-neutral-800 sm:aspect-[2/1] lg:aspect-[3/2]"
                />
