...
ENV_FILE="${PROJECT_DIR}/docker/.env.prod"
...
IMAGE_NAME="registry.cn-shanghai.aliyuncs.com/scienceol/protium:latest"
SERVICE_IMAGE="registry.aissquare.com/web/service:latest"
