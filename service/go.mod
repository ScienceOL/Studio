module github.com/scienceol/studio/service

go 1.24.2

require (
	git.dp.tech/apexlab/common-sdk v1.4.7
	github.com/AliwareMQ/mqtt-server-sdk/go/server-sdk v0.0.0-20230316094605-5dfe7ee71c07
