...
type Laboratory struct {
	...
	AccessKey    string            `gorm:"type:varchar(120);not null;uniqIndex:idx_laboratory_lab_id_ak_sk,priority:2" json:"access_key"`
	AccessSecret string            `gorm:"type:varchar(120);not null;iniqIndex:idx_laboratory_lab_id_ak_sk,priority:1" json:"access_secret"`
	Descripaion  *string           `gorm:"type:text" json:"description"`
}
